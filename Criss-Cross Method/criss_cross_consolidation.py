...
class Project:
    ...
    def __init__(self, parent=None):
        ...
        if min(z_star_n) < 0.0 and min(x_starB) < 0.0:
            ...
            print "So, performing Criss Cross Method..."
            pt3.criss_cross_solver(z_star_n, matrix_B, matrix_N, x_starB, self.b, self.c, self.Beta, self.Nu, objective)
            sys.exit()
